...
<h2 class='text-subheading mt-4'> Create a new Next js project
</h2>
``` javascript
npx create-next-app custom_cache_demo
```
<h2 class='text-subheading'>  In the next.config.js add these two line
</h2>
...
<h2 class='text-subheading'>  Then create cache-handler.js in root folder
<h2/>
``` javascript 
const cache = new Map()
...
```
<h2 class='text-subheading'>   let's test
</h2>
``` javascript
